...
*/
/**************************************************************************/
bool Adafruit_BNO055::getOspreyEvent(sensors_event_t *event, adafruit_vector_type_t vecType)
{
  /* Clear the event */
  ...
  imu::Vector<3> vec = getVector(vecType);

  if (vecType == Adafruit_BNO055::VECTOR_ACCELEROMETER)
  {
  ...
  else if (vecType == Adafruit_BNO055::VECTOR_MAGNETOMETER)
  {
